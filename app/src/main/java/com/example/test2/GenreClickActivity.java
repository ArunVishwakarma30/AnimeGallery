...
public class GenreClickActivity extends AppCompatActivity implements SelectListener, PopupMenu.OnMenuItemClickListener {

    RecyclerView genreClickedRecycler;
    AllAnimeAdapter adapter;
    private int page = 1;
    ProgressDialog dialog;
    GenreModel genreType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_genre_click);

        genreType = (GenreModel) getIntent().getSerializableExtra("gen");
        int genId = genreType.getMal_id();
        ...
        searchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(GenreClickActivity.this, searchActivity.class));
            }
        });
        ...
        dialog.setTitle("Getting " + genreType.getName() + " Anime For You");
        dialog.show();
        dialog.setCancelable(false);

        genreClickedRecycler = findViewById(R.id.genreClickRecycler);


        RequestManager manage = new RequestManager(this);
        manage.getAnimeByStatus(genreClickedListener, 1, "", genId, "");

        currentTime = Calendar.getInstance().getTime();

        // custom dialog
        customDialog = new Dialog(GenreClickActivity.this);
        ...
        okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(GenreClickActivity.this, LoginActivity.class));
            }
        });
    ...
    private final OnFetchDataListener<JikanApiResponse> genreClickedListener = new OnFetchDataListener<JikanApiResponse>() {
        @Override
        public void onFetchData(List<AnimeData> list, String message) {
            showAnime(list, genreClickedRecycler);
            dialog.dismiss();
        }
    ...
    public void onAnimeClicked(AnimeData animeData) {
        startActivity(new Intent(GenreClickActivity.this, DetailsActivity.class)
                    ...
                    firebaseFirestoreDb.collection(mailName + action)
                            ...
                            .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                ...
                                public void onSuccess(DocumentReference documentReference) {
                                    Toast.makeText(GenreClickActivity.this, "Added", Toast.LENGTH_SHORT).show();
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(GenreClickActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                                }
                            });
                } else {
                                        ...
                                        firebaseFirestoreDb.collection(mailName + action)
                                                ...
                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    public void onSuccess(Void unused) {
                                                        Toast.makeText(GenreClickActivity.this, "Successfully Removed", Toast.LENGTH_SHORT).show();
                                                    }
                                                }).addOnFailureListener(new OnFailureListener() {
                                                    @Override
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(GenreClickActivity.this, "Failed To delete", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                    } else {
                                        Toast.makeText(GenreClickActivity.this, "Data is not in the database", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }
